...
function fresh(room){return {engineVersion:2,started:true,current:0,rolled:false,lastDice:[0,0],players:room.players.map((p,i)=>({onlineId:p.id,name:p.name,money:1500000,pos:0,skip:0,jail:false,jailTurns:0,bankrupt:false,color:i})),titles:{},deck:[],deckPos:0,logs:['Cada jogador deve lançar os dados para decidir quem começa.'],turnNumber:1,choices:[],trades:[],moneyEvents:[],bankFlow:-1500000*room.players.length,initiative:{round:1,eligible:room.players.map((_,i)=>i),rolls:{},complete:false,winner:null}}}
